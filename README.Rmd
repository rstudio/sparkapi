...
| [`sparklingwater`](https://github.com/jjallaire/sparklingwater) | Simple demo / proof-of-concept extension for using the Sparking Water package from H2O.  |
...
| spark\_version | Get the version of Spark (as a `numeric_version`) for a `spark_connection` |
